...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 18 05:25:11 2022
...
if __name__=='__main__':
    ...
    if len(sys.argv) > 1 and sys.argv[1] =='play':
        ...
        j = np.load('es_qkprotocol_results02.npz')
        ...
        np.savez('es_qkprotocol_results01.npz',
        ...
        for _ in range(episodes):
            Rew, ac,steps=reward_function(best_params,_)
            print(Rew)
            print(steps)
            #Rewa+=Rew
