...
class DQNAgent:
    ...
    def replay(self, batch_size):
        ...
        for state, action, reward, next_state, done in minibatch:
            ...
            #print('This is the target f {}'.format(target_f))
            target_f[0][action]=target
            self.model.fit(state, target_f, epochs=20, verbose=0)
    ...
    for e in range(EPISODES):
        ...
        for time in range(50):
            ...
            if done:
                ...
                if reward==1:
                    solved+=1                
                print("episode : {}/{}, score: {}, e: {:.2} solved {} reward {}".format(e, EPISODES, time, agent.epsilon, solved,reward))
                break 
