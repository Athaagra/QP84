...
#    epochs, penalties, reward = 0, 0, 0
    ...
    while done1!=True or done2!=True or done3!=True or done4!=True or done5!=True or done6!=True or done7!=True or done8!=True or done9!=True or done10!=True or done11!=True or done12!=True or done13!=True or done14!=True or done15!=True or done16!=True:
        ...
        stat9,re9,do9,action_h1=envs.step(action09)
        stat10,re10,do10,action_h2=envs.step(action10)
        stat11,re11,do11,action_h3=envs.step(action11)
        stat12,re12,do12,action_h4=envs.step(action12)
        stat13,re13,do13,action_h5=envs.step(action13)
        stat14,re14,do14,action_h6=envs.step(action14)
        stat15,re15,do15,action_h7=envs.step(action15)
        stat16,re16,do16,action_h8=envs.step(action16)
        done1=do1
        done2=do2
        done3=do3
        done4=do4
